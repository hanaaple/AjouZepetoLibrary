...
export default class SelfieCamera extends ZepetoScriptBehaviour {
  ...
  private CameraMovement() {
    ...
    var camDir: Vector3 = Vector3.op_Addition(
      Vector3.op_Multiply(this.targetLookAt.forward, -1),
      Vector3.op_Multiply(this.targetLookAt.right, this.rightOffset)
    );
    ...
    this.currentPos = Vector3.op_Addition(
    ...
    this.transform.position = Vector3.Lerp(
      ...
      Vector3.op_Addition(
        this.currentPos,
        Vector3.op_Multiply(camDir, this.distance)
      ),
      0.9
    );

    var lookPoint: Vector3 = Vector3.op_Addition(
      this.currentPos,
      Vector3.op_Multiply(this.targetLookAt.forward, 2)
    );
    lookPoint = Vector3.op_Addition(
      lookPoint,
      Vector3.op_Multiply(
    ...
    this.currentTarget.eulerAngles = new Vector3(
      0,
      this.currentTarget.eulerAngles.y,
      0
    );
  }
